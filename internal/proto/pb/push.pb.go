...
func (m *MsgNotifyReq) GetMsgId() string {
	if m != nil {
		return m.MsgId
	}
	return ""
...
var fileDescriptor_d1e4bfd2e9d102bb = []byte{
	...
	0xe9, 0xf1, 0x99, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0xac, 0xb9, 0xc5, 0xe9, 0x9e,
	0x29, 0x42, 0xb2, 0x5c, 0x5c, 0xc5, 0xa9, 0x79, 0x29, 0xa9, 0x45, 0xf1, 0xa5, 0x99, 0x29, 0x12,
	0x4c, 0x60, 0x29, 0x4e, 0x88, 0x48, 0x68, 0x66, 0x8a, 0x90, 0x3c, 0x17, 0x77, 0x51, 0x6a, 0x72,
	0x6a, 0x66, 0x59, 0x2a, 0x58, 0x9e, 0x19, 0x2c, 0xcf, 0x05, 0x15, 0x02, 0x29, 0x90, 0xe0, 0x62,
	0x2f, 0x2e, 0x4d, 0xca, 0x4a, 0x4d, 0x2e, 0x91, 0x60, 0x01, 0x4b, 0xc2, 0xb8, 0x4a, 0x6a, 0x5c,
	0xbc, 0x48, 0x0e, 0x28, 0x2e, 0x40, 0x73, 0x01, 0x33, 0xd4, 0x05, 0x4e, 0x12, 0x27, 0x1e, 0xc9,
	...
	0xff, 0x97, 0xa0, 0x19, 0xe9, 0xde, 0x00, 0x00, 0x00,
}
...
func (m *MsgNotifyReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MsgId) > 0 {
		i -= len(m.MsgId)
		copy(dAtA[i:], m.MsgId)
		i = encodeVarintPush(dAtA, i, uint64(len(m.MsgId)))
		i--
		dAtA[i] = 0xa
	}
